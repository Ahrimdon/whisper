...
if not exist "output/transcriptions/%FILENAME%" mkdir "output/transcriptions/%FILENAME%"

whisper input/%FULLNAME% --model %model% --language %LANGUAGE% --fp16 False --task transcribe --output_dir "output/transcriptions/%FILENAME%"
